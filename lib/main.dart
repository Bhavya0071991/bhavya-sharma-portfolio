        ...
        children: [
          ...
          Column(
            children: [
              // Navigation bar
              Padding(
                padding: const EdgeInsets.only(top:100.0, bottom: 50.0, left: 100.0, right: 100.0),
                child: Row(
      ...
      children: [
        ...
        Positioned.fill(
          child: FadeInImage.assetNetwork(
            placeholder:'assets/banner2.png', // Add a placeholder image in assets
            image: 'assets/banner2.png', // Replace with your image path
            fit: BoxFit.cover,
              ...
              children: [
                Expanded(
                  child: _buildProjectCard(
                    'Breath & Heart',
                    'This app is developer in native android using Kotlin',
